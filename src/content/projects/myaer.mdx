...
title: Myaer
date: 8-8-2021
description: "General purpose" Discord bot with features like starboard, last.fm API commands, Hypixel API commands,
and Spotify commands.
image: ../assets/myaer.png
info:
  - text: GitHub
    link: https://github.com/myerDOT/Myaer
        icon:
        type: lucide
        name: github
---
